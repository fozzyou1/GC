...
public class CameraController : MonoBehaviour
{
	...
	void LateUpdate()
	{
		Vector3 camPos = focusObj.transform.position + Vector3.up * camHeight + Vector3.back * camBack;
	...
	*/
	...
	public void cameraRotate(Vector3 eulerAngle)
	{
		...
		q.SetLookRotation (this.focusObj.transform.position) ;
